...
+(NSDate*)getFirstDayOfWeekByDate:(NSDate*)date{
    ...
    [comps setMinute:0];
    [comps setSecond:0];
    NSDate *firstDay = [calendar dateByAddingComponents:comps toDate:date options:0];
    return firstDay;
}

+ (NSDate *)getNextWeekWithDate:(NSDate *)currentDate days:(int)day;
{
    NSCalendar *cal = [NSCalendar currentCalendar];
    NSDateComponents *dateComponents = [[NSDateComponents alloc] init];
    dateComponents.day = day;
    return [cal dateByAddingComponents:dateComponents toDate:currentDate options:0];
}
